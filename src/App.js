      ...
      try {
        ...
        const sampleData = [
          ...
          },
          {
            ...
            "Fornecedor": "Bebidas Ltda",
            "Estoque": 200,
            "Saída Cúbica/Dia": 0.027583,
            "Peso (kg)": 2.1,
            "Dimensões (cm)": "12x12x30",
            "Preço": 7.50
          },
          {
            "Código": "1003",
            "Descrição": "Detergente Líquido 500ml",
            "Departamento": "Limpeza",
            "Categoria": "Produtos de Limpeza",
            "Fornecedor": "Clean & Cia",
            "Estoque": 300,
          ...
          {
            "Código": "1004",
            "Descrição": "Feijão Preto 1kg",
            "Departamento": "Alimentos",
            "Categoria": "Grãos",
            "Fornecedor": "Distribuidora ABC",
            "Estoque": 120,
            "Saída Cúbica/Dia": 0.012345,
            "Peso (kg)": 1.0,
            "Dimensões (cm)": "10x20x5",
            "Preço": 6.99
          },
          {
            "Código": "1005",
            "Descrição": "Água Mineral 5L",
            "Departamento": "Bebidas",
            "Categoria": "Águas",
            "Fornecedor": "Bebidas Ltda",
            "Estoque": 80,
            "Saída Cúbica/Dia": 0.054321,
            "Peso (kg)": 5.1,
            "Dimensões (cm)": "15x15x35",
            "Preço": 9.90
          },
          {
            "Código": "1006",
            "Descrição": "Sabão em Pó 1kg",
            "Departamento": "Limpeza",
            "Categoria": "Produtos de Limpeza",
            "Fornecedor": "Clean & Cia",
            "Estoque": 150,
            "Saída Cúbica/Dia": 0.007654,
            "Peso (kg)": 1.05,
            "Dimensões (cm)": "15x25x8",
            "Preço": 12.50
          },
          {
            "Código": "1007",
            "Descrição": "Açúcar Refinado 1kg",
            "Departamento": "Alimentos",
            "Categoria": "Açúcares",
            "Fornecedor": "Distribuidora ABC",
            "Estoque": 200,
            "Saída Cúbica/Dia": 0.098765,
            "Peso (kg)": 1.0,
            "Dimensões (cm)": "10x20x5",
            "Preço": 4.99
          },
          {
            "Código": "1008",
            "Descrição": "Suco de Laranja 1L",
            "Departamento": "Bebidas",
            "Categoria": "Sucos",
            "Fornecedor": "Bebidas Ltda",
            "Estoque": 100,
            "Saída Cúbica/Dia": 0.002345,
            "Peso (kg)": 1.05,
            "Dimensões (cm)": "10x10x25",
            "Preço": 8.75
          },
          {
            "Código": "1009",
            "Descrição": "Desinfetante 1L",
            "Departamento": "Limpeza",
            "Categoria": "Produtos de Limpeza",
            "Fornecedor": "Clean & Cia",
            "Estoque": 180,
            "Saída Cúbica/Dia": 0.015678,
            "Peso (kg)": 1.05,
            "Dimensões (cm)": "10x10x25",
            "Preço": 5.99
          },
          {
            "Código": "1010",
            "Descrição": "Macarrão Espaguete 500g",
            "Departamento": "Alimentos",
            "Categoria": "Massas",
            "Fornecedor": "Distribuidora ABC",
            "Estoque": 250,
            "Saída Cúbica/Dia": 0.045678,
            "Peso (kg)": 0.52,
            "Dimensões (cm)": "5x25x3",
            "Preço": 3.50
          },
          {
            "Código": "1011",
            "Descrição": "Cerveja Lata 350ml",
            "Departamento": "Bebidas",
            "Categoria": "Alcoólicos",
            "Fornecedor": "Bebidas Ltda",
            "Estoque": 400,
            "Saída Cúbica/Dia": 0.065432,
            "Peso (kg)": 0.37,
            "Dimensões (cm)": "7x7x15",
            "Preço": 3.99
          },
          {
            "Código": "1012",
            "Descrição": "Amaciante 2L",
            "Departamento": "Limpeza",
            "Categoria": "Produtos de Limpeza",
            "Fornecedor": "Clean & Cia",
            "Estoque": 120,
            "Saída Cúbica/Dia": 0.023456,
            "Peso (kg)": 2.05,
            "Dimensões (cm)": "12x12x30",
            "Preço": 14.90
          }
    ...
    const processedData = rawData.map(row => {
      ...
      if (mapping.dailyCubicOutput) {
        ...
        if (typeof processedRow._mappedDailyCubicOutput === 'string') {
          processedRow._mappedDailyCubicOutput = parseFloat(processedRow._mappedDailyCubicOutput);
        }
      }
  ...
  const processData = (items, params = parameters) => {
    ...
    const processed = items.map(item => {
      ...
      if (columnMapping && columnMapping.dailyCubicOutput) {
        ...
        saidaCubicaDia = typeof rawValue === 'number' ? rawValue : parseFloat(rawValue) || 0;
      } else {
